                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                >
                                <router-link :to="{ name: 'TestimonialAdd' }">
                        ...
                        <div class="card-body">
                            ...
                            <div v-if="testimonials.meta">
                                <el-pagination
                                    class="text-center mt-4"
                                    background
                                    @current-change="handleCurrentChange"
                                    :current-page.sync="currentPage"
                                    :page-size="testimonials.meta.per_page"
                                    layout="prev, pager, next"
                                    :total="testimonials.meta.total"
                                >
                                </el-pagination>
                            </div>
                            <el-dialog
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange() {
            this.loading = true;
            this.$store
                .dispatch("testimonial/testimonialList", this.currentPage)
                .then(result => {
                    this.loading = false;
                });
        },
        ...
        multipleDelete() {
            ...
            axios
                .post(
                    "/api/admin/testimonials/multiple-delete",
    ...
    computed: {
        testimonials() {
            return this.$store.getters["testimonial/testimonialList"];
        }
    }
};
</script>
