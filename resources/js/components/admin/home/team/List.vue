                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            >
                                ...
                                <el-table-column property="dagenation" :label="`${$t('Dagenation')}`">
                                </el-table-column>
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange() {
            this.loading = true;
            this.$store
                .dispatch("team/teamList", this.currentPage)
                .then(result => {
                    this.loading = false;
                });
        },
        ...
        multipleDelete() {
            ...
            axios
                .post(
                    "/api/admin/teams/multiple-delete",
    ...
    computed: {
        teams() {
            return this.$store.getters["team/teamList"];
        }
    }
};
</script>
