                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    >
                                        ...
                                        >
                                            <input type="text" class="form-control"
                                                v-model="form.blog_sub_title"
                                            >
                                            <span
                                                class="text-danger"
                                                v-if="errors.blog_sub_title"
                                            >
                                                {{ errors.blog_sub_title[0] }}
                                            </span>
                                        </el-form-item>
                                        <el-button
...
export default {
    ...
    watch: {
        sectiontitle() {
            this.form.blog_title = this.sectiontitle.blog_title;
            this.form.blog_sub_title = this.sectiontitle.blog_sub_title;
        }
    }
};
</script>
