...
export default {
    ...
    methods: {
        save() {
            this.loading = true;
            axios
                .post("/api/admin/features", this.form)
                .then(result => {
                    this.loading = false;
                    this.form = null;
        ...
        update() {
            this.loading = true;
            axios
                .put(`/api/admin/features/${this.$route.params.id}`, this.form)
                .then(result => {
                    this.loading = false;
                    this.form = null;
                    this.$router.push({ name: "FeatureList" });
    ...
    computed: {
        feature() {
            return this.$store.getters["feature/singleFeature"];
        }
    },
    watch: {
        feature() {
            this.form = this.feature;
        }
    }
};
</script>
