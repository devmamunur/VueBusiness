                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                >
                                <router-link :to="{ name: 'WhayChooseAdd' }">
                        ...
                        <div class="card-body">
                            ...
                            <div v-if="whayChooses.meta">
                                <el-pagination
                                    class="text-center mt-4"
                                    background
                                    @current-change="handleCurrentChange"
                                    :current-page.sync="currentPage"
                                    :page-size="whayChooses.meta.per_page"
                                    layout="prev, pager, next"
                                    :total="whayChooses.meta.total"
                                >
                                </el-pagination>
                            </div>
                            <el-dialog
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange() {
            this.loading = true;
            this.$store
                .dispatch("whayChoose/whayChooseList", this.currentPage)
                .then(result => {
                    this.loading = false;
                });
        },
        ...
        multipleDelete() {
            ...
            axios
                .post(
                    "/api/admin/whay-chooses/multiple-delete",
        ...
        deleteFunc(id) {
            this.loading = true;
            axios
                .delete("/api/admin/whay-chooses/" + id)
                .then(result => {
                    this.$notify({
                        title: 'Success',
                        message: 'Data Deleted Successfully',
    ...
    computed: {
        whayChooses() {
            return this.$store.getters["whayChoose/whayChooseList"];
        }
    }
};
</script>
