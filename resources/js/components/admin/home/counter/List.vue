                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                >
                                <router-link :to="{ name: 'CounterAdd' }">
                        ...
                        <div class="card-body">
                            ...
                            >
                                ...
                                <el-table-column property="number" :label="`${$t('Value')}`">
                                </el-table-column>
                            ...
                            <div v-if="counters.meta">
                                <el-pagination
                                    class="text-center mt-4"
                                    background
                                    @current-change="handleCurrentChange"
                                    :current-page.sync="currentPage"
                                    :page-size="counters.meta.per_page"
                                    layout="prev, pager, next"
                                    :total="counters.meta.total"
                                >
                                </el-pagination>
                            </div>
                            <el-dialog
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange() {
            this.loading = true;
            this.$store
                .dispatch("counter/counterList", this.currentPage)
                .then(result => {
                    this.loading = false;
                });
        },
        ...
        multipleDelete() {
            ...
            axios
                .post(
                    "/api/admin/counters/multiple-delete",
    ...
    computed: {
        counters() {
            return this.$store.getters["counter/counterList"];
        }
    }
};
</script>
