                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div v-if="sliders.meta">
                                <el-pagination
                                    class="text-center mt-4"
                                    background
                                    @current-change="handleCurrentChange"
                                    :current-page.sync="currentPage"
                                    :page-size="sliders.meta.per_page"
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange() {
            this.loading = true;
            this.$store
                .dispatch("slider/sliderList", this.currentPage)
                .then(result => {
                    this.loading = false;
                });
        },
        ...
        multipleDelete() {
            ...
            axios
                .post(
                    "/api/admin/sliders/multiple-delete",
