                                ...
                                <div class="col-lg-8">
                                    <el-form label-position="top" @submit.prevent="saveOrUpdate">
                                        ...
                                        <el-form-item :label="`${$t('Select Category')} *`">
                                            ...
                                            <span
                                                class="text-danger"
                                                v-if="errors.bcategory_id"
                                            >
                                                {{ errors.bcategory_id[0] }}
                                            </span>
                                        </el-form-item>
...
export default {
    ...
    methods: {
        ...
        blogCategoryListAll() {
            this.$store.dispatch("blogCategory/blogCategoryListAll");
        },
        save(formData) {
            this.loading = true;

            axios
                .post("/api/admin/blogs", formData)
                .then(result => {
                    this.loading = false;
                    this.form = null;
        ...
        update(formData) {
            ...
            axios
                .post(
                    `/api/admin/blogs/update/${this.$route.params.id}`,
                    formData
                )
                .then(result => {
                    this.loading = false;
        ...
        saveOrUpdate() {
            ...
            formData.append("bcategory_id", this.form.bcategory_id);
