                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            >
                                ...
                                <el-table-column property="title" :label="`${$t('Title')}`"></el-table-column>
                                <el-table-column property="position" :label="`${$t('Position')}`">
                                </el-table-column>
                                <el-table-column
                                    :label="`${$t('Category')}`"
                                >
                                    <template slot-scope="scope">{{
                                        scope.row.job_category.name
                                    }}</template>
                                </el-table-column>
                                <el-table-column  :label="`${$t('Deadline')}`">
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange() {
            this.loading = true;
            this.$store
                .dispatch("job/jobList", this.currentPage)
                .then(result => {
                    this.loading = false;
                });
        },
        ...
        multipleDelete() {
            ...
            axios
                .post(
                    "/api/admin/jobs/multiple-delete",
