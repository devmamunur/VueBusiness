                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                >
                                <router-link :to="{ name: 'PortfolioAdd' }">
                            ...
                            >
                                ...
                                <el-table-column property="featured_image" :label="`${$t('Image')}`">
                                    <template slot-scope="scope">
                                        <img
                                            :src="`/uploads/${scope.row.featured_image}`"
                                            alt=""
                                            class="tImg"
                                        />
                                    </template>
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange() {
            this.loading = true;
            this.$store
                .dispatch("portfolio/portfolioList", this.currentPage)
                .then(result => {
                    this.loading = false;
                });
        },
        ...
        multipleDelete() {
            ...
            axios
                .post(
                    "/api/admin/portfolios/multiple-delete",
    ...
    computed: {
        portfolios() {
            return this.$store.getters["portfolio/portfolioList"];
        }
    }
};
</script>
