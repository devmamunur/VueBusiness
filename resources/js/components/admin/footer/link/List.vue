                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                >
                                <router-link :to="{ name: 'FooterLinkAdd' }">
                        ...
                        <div class="card-body">
                            ...
                            <div v-if="footerlinks.meta">
                                <el-pagination
                                    class="text-center mt-4"
                                    background
                                    @current-change="handleCurrentChange"
                                    :current-page.sync="currentPage"
                                    :page-size="footerlinks.meta.per_page"
                                    layout="prev, pager, next"
                                    :total="footerlinks.meta.total"
                                >
                                </el-pagination>
                            </div>
                            <el-dialog
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange() {
            this.loading = true;
            this.$store
                .dispatch("footerlink/footerlinkList", this.currentPage)
                .then(result => {
                    this.loading = false;
                });
        },
        ...
        multipleDelete() {
            ...
            axios
                .post(
                    "/api/admin/footerlinks/multiple-delete",
        ...
        deleteFunc(id) {
            this.loading = true;
            axios
                .delete("/api/admin/footerlinks/" + id)
                .then(result => {
                    this.$notify({
                        title: 'Success',
                        message: 'Data Deleted Successfully',
    ...
    computed: {
        footerlinks() {
            return this.$store.getters["footerlink/footerlinkList"];
        }
    }
};
</script>
