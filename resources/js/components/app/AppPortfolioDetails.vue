            ...
            <template v-if="portfolioImages.length > 0">
              <div class="portfolio-details-slider">
                <VueSlickCarousel v-bind="sliderSettings">
                  <div
                    class="image"
                    v-for="(portfolioImage, i) in portfolioImages"
                    :key="i"
                  >
          ...
          <div class="case-live">
            <div class="case-live-item-area">
              <div class="case-live-item">
                ...
                <span v-if="portfolio.client_name">{{
              ...
              <div class="case-live-item">
                ...
                <span v-if="portfolio.start_date">{{
              ...
              <div class="case-live-item">
                ...
                <span v-if="portfolio.submission_date">{{
            ...
            <div class="case-live-btn text-center" v-if="portfolio.link">
              <a class="main-btn" :href="portfolio.link">{{
                $t("Live Preview")
              }}</a>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    getSinglePortfolioImages() {
      this.$store.dispatch(
        "index/getSinglePortfolioImages",
